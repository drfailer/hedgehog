...
#ifndef HEDGEHOG_TASK_MULTI_SENDERS_H
#define HEDGEHOG_TASK_MULTI_SENDERS_H

#include "multi_senders.h"
#include "../../tools/concepts.h"
#include "../../core/abstractions/node/task_outputs_management_abstraction.h"
/// @brief Hedgehog main namespace
namespace hh {
/// @brief Hedgehog behavior namespace
namespace behavior {

/// @brief Behavior abstraction for tasks that send multiple types of data
/// @tparam Outputs Types of data the task sends
template<class ...Outputs>
class TaskMultiSenders : public MultiSenders<Outputs...> {
 private:
 ...
 protected:
  /// @brief Add result and send it to the task successors
...
#endif //HEDGEHOG_TASK_MULTI_SENDERS_H
